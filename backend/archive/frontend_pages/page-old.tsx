            ...
            <div className="min-h-screen bg-gradient-to-br from-white via-orange-50 to-purple-50">
                ...
                <section className="relative pt-32 pb-20 px-4">
                    <div className="max-w-6xl mx-auto text-center">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <Link
                                href="/signup"
                                className="px-8 py-4 bg-black text-white font-semibold rounded-lg hover:bg-gray-800 transition-all transform hover:scale-105 flex items-center justify-center gap-2"
                            >
                ...
                <section className="py-20 px-4 bg-gradient-to-br from-blue-50 to-purple-50">
                    <div className="max-w-6xl mx-auto">
                        ...
                        <p className="text-center text-gray-600 mb-12 text-lg">
                            One unified platform, multiple use cases. Whether you're hiring, practicing, or building a marketplace - SwarmHire adapts to your needs.
                        </p>
                        ...
                        <div className="mt-8 text-center">
                            <p className="text-gray-600 italic">
                                💡 <strong>The best part?</strong> All three use cases run on the same unified platform. One login, one dashboard, infinite possibilities.
                            </p>
                        </div>
                    </div>
                </section>
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                            ...
                            <div className="p-8 bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl border-2 border-blue-200">
                                <div className="flex items-center gap-3 mb-4">
                                    ...
                                    <div>
                                        <h3 className="text-xl font-bold text-gray-900">EPAM Systems</h3>
                                        <p className="text-xs text-gray-600">Tenant ID: epam</p>
                                    </div>
                                </div>
                                <ul className="space-y-2 text-xs text-gray-700">
                                    <li>✓ Isolated database with RLS</li>
                                    <li>✓ Custom role templates</li>
                                    <li>✓ Private interview data</li>
                                    <li>✓ EPAM-specific branding</li>
                                </ul>
                            </div>
                            ...
                            <div className="p-8 bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl border-2 border-purple-200">
                                <div className="flex items-center gap-3 mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-gray-600">Tenant ID: google</p>
                                    </div>
                                </div>
                                <ul className="space-y-2 text-xs text-gray-700">
                                    <li>✓ Completely separate data</li>
                                    <li>✓ Custom role templates</li>
                                    <li>✓ Private interview data</li>
                                    <li>✓ Google-specific branding</li>
                                </ul>
                            </div>

                            {/* Expert Studio (B2C) */}
                            <div className="p-8 bg-gradient-to-br from-green-50 to-green-100 rounded-xl border-2 border-green-200">
                                <div className="flex items-center gap-3 mb-4">
                                    <div className="w-16 h-16 bg-green-600 rounded-lg flex items-center justify-center text-white font-bold text-2xl">
                                        S
                                    </div>
                                    <div>
                                        <h3 className="text-xl font-bold text-gray-900">Expert Studio</h3>
                                        <p className="text-xs text-gray-600">Tenant ID: studio</p>
                                    </div>
                                </div>
                                <ul className="space-y-2 text-xs text-gray-700">
                                    <li>✓ Monetized Lab Packages</li>
                                    <li>✓ Personal Review Queue</li>
                            ...
                            <div className="p-8 bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl border-2 border-orange-200">
                                <div className="flex items-center gap-3 mb-4">
                                    ...
                                    <div>
                                        <h3 className="text-xl font-bold text-gray-900">Private Circle</h3>
                                        <p className="text-xs text-gray-600">Tenant ID: circle</p>
                                    </div>
                                </div>
                                <ul className="space-y-2 text-xs text-gray-700">
                                    <li>✓ Anti-Leak Privacy Controls</li>
                                    <li>✓ ID & Safety Verification</li>
                                    <li>✓ Personal Vibe-Checks</li>
                ...
                <section className="py-20 px-4 bg-white">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <Link
                                href="/signup"
                                className="px-10 py-5 bg-brand-primary text-white font-bold rounded-lg hover:bg-brand-primary-dark transition-all transform hover:scale-105 text-lg shadow-lg flex items-center justify-center gap-2"
                            >
                                <span>Start Free Trial</span>
                                <span>→</span>
                            </Link>
                            ...
                            <Link
                                href="/subscription"
                                className="px-10 py-5 border-2 border-brand-primary bg-white text-brand-primary font-semibold rounded-lg hover:bg-brand-primary hover:text-white transition-all text-lg"
                            >
                                View Pricing
                            </Link>
                        </div>
                        ...
                        <div className="grid md:grid-cols-4 gap-8 mb-8">
                            ...
                            <div>
                                ...
                                <ul className="space-y-2 text-sm text-gray-400">
                                    ...
                                    <li><Link href="/subscription" className="hover:text-brand-primary">Pricing</Link></li>
                                    <li><Link href="/docs" className="hover:text-brand-primary">Documentation</Link></li>
                                    <li><Link href="/dashboard" className="hover:text-brand-primary">Dashboard</Link></li>
                                </ul>
                            </div>
                            ...
                            <div>
                                ...
                                <ul className="space-y-2 text-sm text-gray-400">
                                    <li><Link href="/quick-start" className="hover:text-brand-primary">Quick Start</Link></li>
                                    <li><Link href="/wiki" className="hover:text-brand-primary">Wiki</Link></li>
                                    <li><Link href="/login" className="hover:text-brand-primary">Login</Link></li>
                                    <li><Link href="/signup" className="hover:text-brand-primary">Sign Up</Link></li>
                                </ul>
                            </div>
                            ...
                            <div>
                                ...
                                <ul className="space-y-2 text-sm text-gray-400">
                                    <li><Link href="/dashboard" className="hover:text-brand-primary">Enterprise Hub</Link></li>
                                    <li><Link href="/expert/studio" className="hover:text-brand-primary">Expert Studio</Link></li>
                                    <li><Link href="/private/circle" className="hover:text-brand-primary">Private Circle</Link></li>
                                </ul>
                            </div>
                        </div>
