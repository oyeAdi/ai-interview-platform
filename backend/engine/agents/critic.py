"""
Critic Agent - Swarm 2.0
Responsible for quality assurance, technical accuracy, and bias audit of all swarm outputs.
"""
...
class CriticAgent(BaseAgent):
    """
    The Critic reviews the work of other agents (Curator, Conductor, etc.).
    ...
    async def process(self, context: AgentContext) -> InferenceOutput:
        ...
        prompt += '{"thought": "Your reasoning about the output quality/bias", "action_type": "quality_audit", "action_data": {"quality_score": 0-100, "bias_detected": true/false, "technical_accuracy": "Low/Medium/High", "adjustment_required": true/false, "suggested_fix": "..."}}'
        
        output = await self.intelligence_provider.generate_structured(prompt)
        
        # Log the critical thought
